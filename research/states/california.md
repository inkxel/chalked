...
Cities researched so far:

- [Los Angeles](../cities/los-angeles.md) — the strongest single first-adapter candidate (see SPEC.md → First adapters to build)
- [San Francisco](../cities/san-francisco.md) — already excellently covered by CURB, not a Chalked adapter target
